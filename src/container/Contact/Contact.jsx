...
const Contact = () => {
  return (
    <><div className="contact app__flex" id="contact">
      <h2 className="header-text contact-header">Contact Me</h2>
      <h3 className="header-text-3 contact__secondary-header">Please feel free to send me a message or connect with me through my social links!</h3>
